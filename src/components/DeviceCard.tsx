...
export default function DeviceCard({device}: {device: Device}) {
    ...
    return (
        <div className="device-card" id={device.id}>
            ...
            <div className="device-card-button" onClick={e => {window.scrollTo({top: 0, behavior: 'smooth'}); e.currentTarget.parentElement?.classList.toggle("device-card-active")}}>관리</div>
